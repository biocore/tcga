...
print("Now extracting column headers and saving in column_names_CDEs.txt ...", end=' ') # The comma here is intentional to print on the same line
...
print("Now finding intersection of column names ...", end=' ') # comma intentional
colFileName = 'column_names_CDEs.txt'
lines_list = open(outputFilePath+colFileName).read().splitlines()
split_lines_list = list(map(str.split, lines_list))
intersection_headers_set = set.intersection(*list(map(set,split_lines_list)))
