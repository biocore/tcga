...
def get_kraken_report(kraken_report_fp,
                      classification_id):
    """Parse Kraken report from output file.

    Parameters
    ----------
    kraken_report_fp: str
    ...
    """
    kraken_report = set()
    with open(kraken_report_fp) as f:
        for line in f:
...
def main(kraken_report_fp,
    ...
    if output_unclassified:
        classification_id = 'U'
    kraken_report = get_kraken_report(kraken_report_fp, classification_id)
